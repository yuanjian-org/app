...
ALWAYS run `yarn build` and `yarn test` before submitting changes.
...
Important: When generating code, proactively fix build and eslint errors in the generated code.
