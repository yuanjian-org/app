...
1. **REMEMBER**: For Aliyun ESC machines, reboot the host after a new domain name is acquired. For some reason Docker on these machines can't recognize the new certificate files otherwise.
