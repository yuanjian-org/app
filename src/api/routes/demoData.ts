...
const mentorProfile1: UserProfile = {
  ...
  职业经历:
    "现任某知名互联网大厂AI产品总监，负责大语言模型在教育和办公场景的应用落地。曾在硅谷知名科技公司担任资深产品经理。热衷于科技向善，积极参与数字支教等公益项目。",
  英文别名: "Flora",
  身份头衔: "互联网大厂AI产品总监",
...
const mentorProfile3: UserProfile = {
  ...
  职业经历:
    "现任一家致力于教育公平的非营利组织联合创始人兼执行总监，主导开发了多套面向乡村青少年的素养课程。曾在国际顶尖咨询公司担任教育行业顾问，拥有丰富的项目管理和跨界合作经验。",
  英文别名: "Alice",
  身份头衔: "教育非营利组织联合创始人",
...
const mentorProfile4: UserProfile = {
  ...
  职业经历:
    "现任知名创新药企研发总监，带领团队负责新型靶向药物的临床前研发。曾在国家级科研机构担任副研究员，发表过多篇高水平国际学术论文，拥有多项发明专利。",
  英文别名: "David",
  身份头衔: "创新药企研发总监",
