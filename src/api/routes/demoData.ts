...
const mentorProfile: UserProfile = {
  ...
  成长亮点:
    "几年前山火烧到离我家很近的地方 需要紧急撤离 意识到生活很久的家可能一夜之间化为灰烬 让我深刻反思了人生的无常 \n\n成就如沙堡 人生如海浪 \n慢慢的学会接受变化 爱自己 享受结果的同时学习享受过程 ",
  擅长话题: "人生思考 社会时事 领导力 美食 旅行 电影 音乐 锻炼 时尚 探险",
  教育经历:
    "卡内基梅隆计算机专业硕士，拥有北京邮电大学电信工程和英国玛丽女皇学院管理双学位。",
  曾居住地: "北京 匹兹堡 硅谷",
  照片链接:
    "https://user-assets.sxlcdn.com/images/937504/FqrY3ykviBotL-y4ckfgMZ1I783Q.png?imageMogr2/strip/auto-orient/thumbnail/500x1000%3E/quality/90!/format/png",
  现居住地: "硅谷",
  生活日常:
    "我有一只10个月大的伯恩山贵宾（行走的毛绒玩具）\n\n喜欢音乐（音乐节 音乐剧）\n",
  职业经历:
    "现任谷歌技术主管经理，是Google Nest智能家居核心模块技术负责人。专注于智能语音交互、用户体验和前端开发，多次在谷歌内部担任项目导师。曾在甲骨文任职。",
  英文别名: "Christina ",
