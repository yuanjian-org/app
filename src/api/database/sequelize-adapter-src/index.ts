 ...
 * "center", padding: 16}}>
 * <p style={{fontWeight: "normal"}}>Official <a
 * href="https://sequelize.org/docs/v6/getting-started/">Sequilize</a> adapter
 * for Auth.js / NextAuth.js.</p>
 *  <a href="https://sequelize.org/">
 * <img style={{display: "block"}}
 * src="https://authjs.dev/img/adapters/sequelize.svg" height="30"/>
 *  </a>
 * </div>
 *
 * ## Installation
...
export interface SequelizeAdapterOptions {
  /**
   * Whether to {@link https://sequelize.org/docs/v6/core-concepts/model-
   * basics/#model-synchronization synchronize} the models or not.
   */
  synchronize?: boolean;
  /**
   * The {@link https://sequelize.org/docs/v6/core-concepts/model-basics/
   * Sequelize Models} related to Auth.js that will be created in your database.
   */
  models?: Partial<{
 ...
 * database](https://sequelize.org/master/manual/getting-started.html) of
 * choice.
 * :::
 *
 * ## Setup
 ...
 * ### Configuring Auth.js
 *
 * Add this adapter to your `pages/api/[...nextauth].js` next-auth configuration
 * object.
 *
 ...
 *
 * // https://sequelize.org/master/manual/getting-started.html#connecting-to-a-
 * database
 ...
 *
 * By default, the sequelize adapter will not create tables in your database. In
 * production, best practice is to create the [required
 * tables](https://authjs.dev/reference/adapters/models) in your database via
 * [migrations](https://sequelize.org/master/manual/migrations.html). In
 * development, you are able to call
 * [`sequelize.sync()`](https://sequelize.org/master/manual/model-
 * basics.html#model-synchronization) to have sequelize create the necessary
 * tables, foreign keys and indexes:
 *
 * > This schema is adapted for use in Sequelize and based upon our main
 * [schema](https://authjs.dev/reference/adapters#models)
 *
 * ```js
 * import NextAuth from "next-auth"
 * import SequelizeAdapter from "@auth/sequelize-adapter"
