...
export const menteeUniqueQualityField = "你最与众不同的品质是什么？";
export const menteeIsFirstTierField = "本科是否是第一批次（一本）？";
export const menteeCoopRecommendField = "合作机构推荐文字";
export const menteeProudExperienceField =
  "请例举一到三个最让你为自己感到骄傲的经历或成果。";
export const menteeCommunityExperienceField =
  "请例举并概述你组织或参加社团工作、社会活动、社区服务等的经历和体会。";
export const menteeIdealField =
...
export const menteeApplicationFields: ApplicationField[] = [
  ...
  {
    jsjField: "field_165",
    jsjProxiedField: "field_165",
    name: menteeSourceField,
    showForEdits: true,
  },
  {
    jsjProxiedField: "field_173",
    name: menteeCoopRecommendField,
    showForEdits: true,
  },
  {
    jsjField: "field_149",
    jsjProxiedField: "field_149",
    name: menteeDegreeField,
    showForEdits: true,
  },
  {
    jsjField: "field_161",
    name: menteeIsFirstTierField,
    showForEdits: true,
  },
  {
    jsjField: "field_107",
    jsjProxiedField: "field_108",
    name: menteeCollegeField,
    showForEdits: true,
  },
  {
    jsjField: "field_108",
    jsjProxiedField: "field_172",
    name: menteeMajorField,
    showForEdits: true,
  },
  {
    jsjField: "field_167",
    jsjProxiedField: "field_167",
  ...
  {
    jsjField: "field_135",
    name: "近期各项科目的成绩列表（或者在下方上传近期成绩单）",
  },
  { jsjField: "field_136", name: "近期成绩单（照片或复印件）" },
  {
    jsjField: "field_163",
    name: "科研论文发表情况（包括发表刊物、作者名单、索引等详细信息。若已在简历中包括，请填 “见简历“）",
  },
  {
    jsjField: "field_164",
    name: "获奖情况（若已在简历中包括，请填 “见简历“）",
  },
  { jsjField: "field_139", name: menteeUniqueQualityField },
  {
    jsjField: "field_140",
    name: menteeProudExperienceField,
  },
  {
    jsjField: "field_157",
    name: menteeCommunityExperienceField,
  },
  {
    jsjField: "field_144",
    name: menteeIdealField,
  },
  {
    jsjProxiedField: "field_174",
    jsjField: "field_145",
