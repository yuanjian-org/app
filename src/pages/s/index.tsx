...
function XLandingPageContent() {
  return (
    <VStack spacing={50} align="start">
      <Section header="远图：零一学院挑战问题与社会导师网络">
        <GridItem colSpan={{ base: 2, [breakpoint]: 5 }}>
          <VStack spacing={paragraphSpacing} align="start">
            ...
            <Text>
              ...
              X-Challenge是由卓越导师发起的、
              面向未来5-10年人类可能面临的重大难题，
              可以影响上亿人或创造万亿市场。
              它聚焦一个领域的长期难题，强调学科交叉与开放性探索。
              目标是通过高难度问题激发学生突破现有知识框架，
              推动对未知领域的探索，共同攻克人类挑战。
              {/* Link to direct users to the public challenges page */}
              您可以点击{" "}
