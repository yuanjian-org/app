    ...
    <>
      ...
      <SmallGrayText>
        ...
        <UnorderedList>
          ...
          <ListItem>使用密码工具自动生成并保存密码。不要试图记忆。</ListItem>
        </UnorderedList>
      </SmallGrayText>
...
function SuccessModal() {
  ...
  return (
    <ModalWithBackdrop isOpen onClose={() => {}}>
      <ModalContent>
        <ModalHeader>密码设置成功</ModalHeader>
        <ModalBody>即将跳转至登录页面。</ModalBody>
        <ModalFooter>
          <Button variant="brand" onClick={() => router.push("/auth/login")}>
            确认
          </Button>
        </ModalFooter>
      </ModalContent>
