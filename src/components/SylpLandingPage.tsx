...
export default function SylpLandingPage() {
  return (
    <BaseLandingPage
      ...
      wide
      navContactTooltip="联系客服 / Contact Support"
      navLoginText="登录 ｜ Login"
    >
      <SimpleGrid columns={{ base: 1, md: 2 }} spacing={10} mt={10}>
        ...
        <VStack spacing={6} align="start">
          ...
          <Text>
            Initiated by the Shanghai Songding Social Innovation and Development
            Center (SSIC), the Sustainable Youth Leadership Program aims to
            cultivate the next generation of leaders equipped with a global
            perspective, cross-cultural communication skills, and a profound
            sense of social responsibility. By integrating ESG principles with
            innovative practices, we provide a cross-sector collaborative
            platform for outstanding youth.
          </Text>
          <Text>
            Here, elite international students will walk alongside top-tier
            industry mentors, delving deeply into social innovation, sustainable
            development, and Corporate Social Responsibility (CSR). The program
            seeks to ignite innovative thinking and develop problem-solving
            skills for complex global issues through the collision of diverse
            perspectives and the study of real-world cases, empowering youth
            leaders to make an impact on the global stage.
          </Text>
          <Heading size="md" pt={4}>
